---
title: GCP Labels and Tags as Teleport agent Labels
description: How to set up Teleport agent labels based on GCP labels and tags
h1: Sync GCP Labels/Tags and Teleport agent Labels
---
