...
- A Teleport Enterprise cluster. If you do not have one, [sign
  ...
  Reference](./reference.mdx) to read about manual updates.
...
server in your cluster. Automatic upgrades in self-hosted Teleport clusters
require at least v14.3.7 or v15.1.3. 
